    ...
    while operand != operands['right']:
        ...
        while True:
            ...
            if (random_num > guess_num and operand == operands['bigger']) \
                ...
                print(
                    'Вы ошиблись при вводе символа сравнения загаданного числа с предложенным.\nПроверьте себя и повторите ввод.')

    print(f'\nКомпьютер угадал Ваше число с {attempts}-й попытки!')
